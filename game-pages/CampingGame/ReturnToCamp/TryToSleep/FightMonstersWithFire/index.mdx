...
{/* If you have the infrared goggles */}
{
    getLevelState().includes("follow-stench") 
        ? <div>
            ...
            <p>James is taken to a hospital to receive blood transfusions. The blade that made the cut was very sharp, so the bleeding hadn't fully stopped yet. The EMTs assure you that he will recover.</p>
