...

{
    getLevelState().includes("gathering-firewood") 
        ...
        : <div>
            <p>You notice the rings under Maxine's eyes and ask her if she had a rough night. She tells you she couldn't sleep; probably due to the noisy forrest.</p>
        </div>
}
